...
namespace ImageOperation
{
    public class ShowImage
    {
        ...
        void disp_colorImg(byte[] mycolor,PictureBox ptb)
        {
        ...
        /// <param name="ptb">图像容器</param>
        void disp_depthImg(float[] myp3d, PictureBox ptb)
        {
            for (int i = 0; i < GLB.BUFH; i++)
            {
                for (int j = 0; j < GLB.BUFW; j++)
        ...
        /// <param name="ptb">图像容器</param>
        void disp_depthImg2(float[] myp3d, PictureBox ptb)
        {
        ...
        /// <param name="myp3d">3D坐标图像</param>
        /// <param name="ptb">图像容器</param>
        void disp_depthImg3(float[] myp3d,PictureBox ptb)
        {
            GLB.TitleStr = "";
            float dis_temp;
